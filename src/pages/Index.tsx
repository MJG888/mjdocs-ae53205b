  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-orange-50 via-background to-orange-100/50" />
        <div className="absolute top-20 right-10 w-72 h-72 bg-primary/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-10 left-10 w-96 h-96 bg-orange-200/30 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }} />
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-primary to-orange-600 rounded-2xl p-8 md:p-16 text-center relative overflow-hidden">
